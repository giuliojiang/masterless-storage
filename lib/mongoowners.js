...
var logger = new logger_1.Logger("mongoowners");
// Public =====================================================================
var add = function (fileid, instanceguid) {
    return __awaiter(this, void 0, void 0, function () {
        var collection, query, existingDocs, doc, insertionResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mongo.getCollection(OWNERS_COLLECTION)];
                case 1:
                    collection = _a.sent();
                    query = {
                        fileid: fileid,
